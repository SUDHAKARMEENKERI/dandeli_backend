...
@Entity
@Table(name="resorHomeStay")
public class ResortHomeStayBean {
	...
	public ResortHomeStayBean (){
		
	}

	public ResortHomeStayBean(int id, String name, String category, String contactNo, String address, String email,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ResortHomeStayBean other = (ResortHomeStayBean) obj;
		if (address == null) {
	...
	public String toString() {
		return "ResortHomeStayBean [id=" + id + ", name=" + name + ", category=" + category + ", contactNo=" + contactNo
